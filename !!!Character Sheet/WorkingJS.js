    ...
    const isDebug = true,
        ...
        marqueeTips = [
            ...
            ["Resonance & Dyscrasias",
             "Strong emotions can give a mortal's blood \"resonance\". Drinking strongly-resonant blood empowers the use of associated disciplines; an",
             "specially strong resonance (called a \"clot\" or a \"dyscrasia\") confers even greater rewards. Over time, it is possible to cultivate a",
             "desired resonance in a mortal — and even, with sufficient effort, confer a dyscrasia upon their blood."],
            ["The Blood Hunt",
    ...
    const doRollRepRefs = () => {
        ...
        doRolls = (targetAttr, opts = {}) => {
            const [repAttrs, attrList] = [[], {}],
                repStatData = Object.assign({}, DISCREPREFS, ADVREPREFS),
