            ...
            if (priorityData.length) {
                ...
                priorityData.forEach((objective) => {
                    ...
                    objRow.push(HTML.box([
                        ...
                        HTML.buttons.flagReviewed("✔", `!char set scheme ${objective.rowID} reviewed ?{Comment ('clear' to remove, blank to leave unchanged, '%N' for line break):}`, C.COLORS.palepalegreen, C.COLORS.darkgreen)
