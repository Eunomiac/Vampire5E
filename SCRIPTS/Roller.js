...
const Roller = (() => {
    ...
    const CHATSTYLES = {
        // "-35px 0px -7px -42px"
        fullBox: `<div style="display: block;width: 259px;padding: 5px 5px;margin: -35px 0px -7px -42px; color: ${C.COLORS.white};font-family: bodoni svtytwo itc tt;font-size: 16px;border: 3px outset ${C.COLORS.darkred};background: url('https://i.imgur.com/QAOQfjw.png') center no-repeat; background-size: cover; position: relative;">`,
        waitBox: `<div style="display: block;width: 259px;padding: 5px 5px;margin: -35px 0px 12px -42px; color: ${C.COLORS.white};font-family: bodoni svtytwo itc tt;font-size: 16px;border: 3px outset ${C.COLORS.darkred};background: url('https://i.imgur.com/QAOQfjw.png') center no-repeat; background-size: cover; position: relative;">`,
        oppBox: `<div style="display: block;width: 259px;padding: 5px 5px;margin: -40px 0px -7px -42px; color: ${C.COLORS.white};font-family: bodoni svtytwo itc tt;font-size: 16px;border: 3px outset ${C.COLORS.darkred};background: url('https://i.imgur.com/QAOQfjw.png') center no-repeat; background-size: cover; position: relative;">`,
    ...
    const applyRollEffects = (rollInput) => {
        const traceID = TRACEON("applyRollEffects", [rollInput]);
        applyRollEffectsTEST(rollInput);
        const rollEffectString = D.GetStatVal(rollInput.charID, "rolleffects") || "";
        let isReapplying = false;
