...
const SCRIPTNAME = "C";
const SCRIPTS = ["C", "D", "Listener", "Fuzzy", "Char", "Media", "Assets", "Player", "Session", "TimeTracker", "DragPads", "Roller", "Soundscape", "Complications", "Handouts", "Chat", "Tester", "InitCommands"];
state = state || {};
