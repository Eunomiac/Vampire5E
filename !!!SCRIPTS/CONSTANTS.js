...
const C = (() => {
    ...
    const STATE = {get REF() { return RO.OT[SCRIPTNAME] }};	// eslint-disable-line no-unused-vars
    ...
    const TEXTCHARS = "0123456789LMNQSOPRUWXTVZY-=●(+ABCFHDEGJIKalmnqsopruwxtvzyfhdegjikbc )?![]:;,.○~♠◌‡⅓°♦\"'`Ծ►/&—ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩⅪⅫⅬⅭⅮⅯ█_@"; // eslint-disable-line quotes
    const NUMBERWORDS = {
