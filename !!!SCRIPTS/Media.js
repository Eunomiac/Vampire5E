...
const Media = (() => {
    ...
    // #region LOCAL INITIALIZATION
        initialize = () => {
            ...
            getObj("graphic", STATE.REF.imgregistry.TombstoneTokenTopLeft_1.id).set("name", "TombstoneTokenTopLeft_1")
            */
