...
const Media = (() => {
    ...
    const setTokenSrc = (charRef, srcName = "base") => {
        ...
        DB(
            {
                tokenObj,
                tokenObjID: tokenObj.id,
                srcName,
                "isToken?": VAL({tokenObj}),
                "isReg?": isRegToken(tokenObj)
            },
            "setTokenSrc"
        );
    ...
    const setImgData = (imgRef, params, isSettingObject = false) => {
