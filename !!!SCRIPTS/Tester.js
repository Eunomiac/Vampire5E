        ...
        switch (call) {
            ...
            case "days": {
                const singleCell = () => {
                    ...
                    const eventSymbol = _.sample(["<span style=\"color: #999999;\"><i>c</i></span>", "o", "<i>d</i>", "p", "<b>T</b>", "ѕ", "<b>S</b>", "f"], 1).join("");
            ...
            case "spread": {
                ...
                const midRefs = ["spreadTest_Mid_1", "spreadTest_Mid_2", "spreadTest_Mid_3", "spreadTest_Mid_4", "spreadTest_Mid_5", "spreadTest_Mid_6"];
