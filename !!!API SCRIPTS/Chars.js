		...
		setNPCStats = (charRef) => {
			...
			for (const charID of charIDs) {
				...
				if (charData.attributes) {
					for (const attribute of _.flatten(_.values(D.ATTRIBUTES))) {
